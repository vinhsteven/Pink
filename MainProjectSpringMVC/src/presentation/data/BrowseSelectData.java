...
public class BrowseSelectData  {
	...
	private List<CatalogPres> catalogs;
	private Map<CatalogPres, List<ProductPres>> productMaps = new HashMap<>();
	
	public List<CatalogPres> getCatalogs(){
		return catalogs;
	}
	
	public void setCatalogs(List<CatalogPres> catalogs){
		this.catalogs = catalogs;
	}
	
	public List<ProductPres> getProductsByCatalog(CatalogPres catalogPres){
		return productMaps.get(catalogPres);
	}
	
	public void addProductsToMap(CatalogPres catalogPres, List<ProductPres> products){
		productMaps.put(catalogPres, products);
	}
	...
	public ProductPres getProductById(int id) throws BackendException{
		ProductPres productPres = new ProductPres();
		productPres.setProduct(browseAndSelectController.getProductForProductId(id));
		return productPres;
	}
